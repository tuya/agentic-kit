...
#include "iot_client_config_defaults.h"   /* pal_strdup, log_*, IOT_DEFAULT_PORT */
#include "iot_client_config_defaults.h"  /* AGENTIC_KIT_MQTT_MAX_PACKET_SIZE (DP publish gate below) */
